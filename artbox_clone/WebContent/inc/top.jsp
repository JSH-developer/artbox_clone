...
<!-- 네비게이션바 -->
 <div class="pageNavigationBar" id="topBar">
		...
		<ul>
			...
			<li class="MyPage">
				<a href="myPageOrders.member" title="로그인" onclick="GA_event('HEAD', '최상단 메뉴', '로그인');">
				<img src="${pageContext.request.contextPath}/Images/common/top_icon_login.png" id="MyInfoSummaryIcon"></a>
				<a href="javascript:location.href='https://www.artboxmall.com:443/Home/Member/Login.asp?rtnURL=%2FHome%2Findex%2Easp';"
				 id="LoginBalloon" onclick="GA_event('HEAD', '최상단 메뉴', '팝업로그인');" style="visibility: hidden;">
				 <img src="/Images/common/login_balloon.png?v=2"></a>
