...
public class EventWriteProAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		eventBean.setEvent_titie(multi.getParameter("event_titie"));
		...
		eventBean.setEvent_limet(multi.getParameter("event_limit"));
		...
		boolean isWriteSuccess = eventWriteProService.writeArticle(eventBean);
