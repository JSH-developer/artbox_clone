...
<!-- 네비게이션바 -->
 <div class="pageNavigationBar" id="topBar">
		<nav id="top_menu">
		<ul>
			<li class="CategoryMiddle"><a href="${pageContext.request.contextPath}/itemList.item?major=DT&page=1&kwd=&minor=&doOrder=">인형/토이</a></li>
			<li class="CategoryMiddle"><a href="${pageContext.request.contextPath}/itemList.item?major=FA&page=1&kwd=&minor=&doOrder=">문구</a></li>
			<li class="CategoryMiddle"><a href="${pageContext.request.contextPath}/itemList.item?major=FS&page=1&kwd=&minor=&doOrder=">패션</a></li>
			<li class="CategoryMiddle"><a href="${pageContext.request.contextPath}/itemList.item?major=KB&page=1&kwd=&minor=&doOrder=">주방/욕실</a></li>
			<li class="CategoryMiddle"><a href="${pageContext.request.contextPath}/itemList.item?major=LD&page=1&kwd=&minor=&doOrder=">리빙/데코</a></li>
			<li class="CategoryMiddle"><a href="${pageContext.request.contextPath}/itemList.item?major=DI&page=1&kwd=&minor=&doOrder=">디지털/가전</a></li>
