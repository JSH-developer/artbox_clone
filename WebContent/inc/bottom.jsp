...
<div class="FooterMenu">
		<ul>
			<li class="FooterLink"><a href="#" >회사소개</a></li>
			<li class="FooterLink"><a href="#" >인재채용</a></li>
			<li class="FooterLink"><a href="#" >이용약관</a></li>
			<li class="FooterLink"><a href="#" >개인정보취급방침</a></li>
			<li class="FooterLink"><a href="#" >이메일주소무단수집거부</a></li>
			<li class="FooterLink"><a href="#" >입점문의</a></li>
			<li class="FooterLink"><a href="#" >대량구매</a></li>
			<li class="FamilySite">
